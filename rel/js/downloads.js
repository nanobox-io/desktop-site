...
temporarilyHideInactiveFeatures = function() {
  $(".os-sections").css({
    display: 'none'
  });
  return $(".btn[bit='32']").css({
    display: 'none'
  });
};
